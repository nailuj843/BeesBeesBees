describe('RetiredForragerBee class functionality', function() {
  
  verifyClass(RetiredForragerBee).followsPattern('pseudoclassical', {}, false);

  beforeEach(function() {
    retiredForrager = new RetiredForragerBee();
  });
